...
# forecast GRIB Dims.
forecast_nlat_idx = station_data['gfs_det_forecast_nlat_idx']
forecast_slat_idx = station_data['gfs_det_forecast_slat_idx']
forecast_wlon_idx = station_data['gfs_det_forecast_wlon_idx']
forecast_elon_idx = station_data['gfs_det_forecast_elon_idx']

# wave GRIB Dims.
wave_nlat_idx = station_data['gfs_det_wave_nlat_idx']
wave_slat_idx = station_data['gfs_det_wave_slat_idx']
wave_wlon_idx = station_data['gfs_det_wave_wlon_idx']
wave_elon_idx = station_data['gfs_det_wave_elon_idx']
