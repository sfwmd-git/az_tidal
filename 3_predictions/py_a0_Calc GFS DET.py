...
# site = 'vaca_key'  # Change this as needed for different sites
...
# THIS LINE FOR MAKING THE ADJUSTMENT
merged_df_NAVD.loc[240, 'noaa_slr'] = merged_df_NAVD.loc[240, 'noaa'] + last_slr
merged_df_NAVD.loc[240, 'station_prediction'] = merged_df_NAVD.loc[240, 'noaa_slr'] + last_dep
