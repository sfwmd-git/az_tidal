...
RUN_NORM_SCRIPT="$BASE_DIR/3_predictions/py_d0_Calc ECMWF ENS.py"
RUN_DEP_SCRIPT="$BASE_DIR/dep_3_predictions/py_d1_Calc ECMWF ENS DEP.py"
RUN_SLP_SCRIPT="$BASE_DIR/slp_3_predictions/py_d2_Calc ECMWF ENS SLP.py"
