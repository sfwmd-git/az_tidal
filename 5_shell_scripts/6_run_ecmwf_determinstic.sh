...
RUN_NORM_SCRIPT="$BASE_DIR/3_predictions/py_c0_Calc ECMWF DET.py"
RUN_DEP_SCRIPT="$BASE_DIR/dep_3_predictions/py_c1_Calc ECMWF DET DEP.py"
RUN_SLP_SCRIPT="$BASE_DIR/slp_3_predictions/py_c2_Calc ECMWF DET SLP.py"
