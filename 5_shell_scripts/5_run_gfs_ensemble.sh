...
GET_ATMO_SCRIPT="$BASE_DIR/3_predictions/py_01_Get GFS ENS GRIB data.py"
GET_WAVE_SCRIPT="$BASE_DIR/3_predictions/py_11_Get WAVE ENS GRIB data.py"
RUN_NORM_SCRIPT="$BASE_DIR/3_predictions/py_b0_Calc GFS ENS.py"
RUN_DEP_SCRIPT="$BASE_DIR/dep_3_predictions/py_b1_Calc GFS ENS DEP.py"
RUN_SLP_SCRIPT="$BASE_DIR/slp_3_predictions/py_b2_Calc GFS ENS SLP.py"
