...
DOWNLOAD_TIDE_SCRIPT="$BASE_DIR/x_validation_analysis/py_1_Get Tide Observations.py"
CLEAN_TIDE_SCRIPT="$BASE_DIR/x_validation_analysis/py_2_Calc Tide Observations.py"
CALC_VALIDATION_READY="$BASE_DIR/x_validation_analysis/py_3_Calc Validation Ready.py"
CALC_VALIDATION_ANALYSIS_ALL="$BASE_DIR/x_validation_analysis/py_4_Calc Validation Analysis All Forecasts.py"
# CALC_VALIDATION_ANALYSIS_ALL="$BASE_DIR/x_validation_analysis/py_4_Calc Validation Analysis All Forecasts - Specific Date.py"
...
for site in $sites; do
    echo "Updating Validation Analysis for: $site"
    # python3 "$DOWNLOAD_TIDE_SCRIPT" --site "$site"
    # python3 "$CLEAN_TIDE_SCRIPT" --site "$site"
    # python3 "$CALC_VALIDATION_READY" --site "$site"
    python3 "$CALC_VALIDATION_ANALYSIS_ALL" --site "$site"
done
