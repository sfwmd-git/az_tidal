...
# forecast GRIB Dims.
forecast_nlat_idx = station_data['gfs_ens_forecast_nlat_idx']
forecast_slat_idx = station_data['gfs_ens_forecast_slat_idx']
forecast_wlon_idx = station_data['gfs_ens_forecast_wlon_idx']
forecast_elon_idx = station_data['gfs_ens_forecast_elon_idx']

# wave GRIB Dims.
wave_nlat_idx = station_data['gfs_ens_wave_nlat_idx']
wave_slat_idx = station_data['gfs_ens_wave_slat_idx']
wave_wlon_idx = station_data['gfs_ens_wave_wlon_idx']
wave_elon_idx = station_data['gfs_ens_wave_elon_idx']
