...
station_fors["Departure"] = station_fors["Observation"] - station_fors["SLR_adj"]
station_fors.loc[0, 'Departure'] = last_dep
...
station_fors_NAVD.loc[0, 'Departure'] = last_dep
...
def process_forecast_grib_files():
    data = []
...
euro = process_forecast_grib_files()
#print(euro)
